...
export default function MiniProductCard({ product }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md hover:border-indigo-200 transition-all flex flex-col">
      {/* Product Image */}
      ...
      <div className="flex items-center justify-between mt-auto">
        ...
        {affiliateLink ? (
          ...
          <span className="px-3 py-1.5 bg-gray-100 text-gray-400 text-sm font-medium rounded-lg">
            Soon
          </span>
        )}
      </div>
