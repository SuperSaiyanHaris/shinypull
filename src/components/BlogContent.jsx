...
export const markdownComponents = {
  ...
  ul: ({ children }) => <ul className="my-4 text-gray-700 list-disc ml-4 md:ml-6">{children}</ul>,
  ol: ({ children }) => <ol className="my-4 text-gray-700 list-decimal ml-4 md:ml-6">{children}</ol>,
  li: ({ children }) => <li className="mb-1 md:mb-2 text-gray-700">{children}</li>,
  ...
  tr: ({ children, isHeader }) => <tr className={isHeader ? '' : 'even:bg-gray-50'}>{children}</tr>,
  th: ({ children }) => (
  ...
  blockquote: ({ children }) => (
    <blockquote className="border-l-4 border-indigo-500 pl-4 my-4 italic text-gray-600">{children}</blockquote>
  ),
};
