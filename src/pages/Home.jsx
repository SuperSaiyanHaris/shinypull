  ...
  return (
    <>
      ...
      <main className="bg-[#fafafa] text-neutral-900">
        ...
        {/* Same browser-mockup treatment as the Rankings/Profile/Compare/Earnings
            carousel above so the visual language is consistent. Shows real top
            creators (pulled from topCreators) with an Ad placement row inserted
            between #3 and #4, exactly how it renders in /rankings. Lets a B2B
            buyer see EXACTLY what they're paying for before clicking through. */}
        <section className="relative pb-16 sm:pb-24">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <motion.div
              ...
              className="relative rounded-2xl bg-white border border-neutral-200 shadow-xl shadow-neutral-200/60 overflow-hidden"
            >
              {/* Browser chrome — matches the live preview carousel above */}
              <div className="flex items-center gap-2 px-4 py-3 border-b border-neutral-200 bg-neutral-50">
                <div className="flex gap-1.5">
                  <div className="w-2.5 h-2.5 rounded-full bg-red-400" />
                  <div className="w-2.5 h-2.5 rounded-full bg-amber-400" />
              ...
              <div className="p-4 sm:p-6">
                ...
                {(() => {
                  ...
                  // Insert the sponsored row between #3 and #4 (real Rankings page placement)
                  const SPONSORED_INDEX = 3;
                  return (
                    <div className="space-y-1">
                      {rows.map((creator, i) => {
                        const displayName = creator?.display_name || fallbackNames[i];
                        ...
                        // Drop the sponsored row in just before #4 — mirrors what /rankings does
                        if (i === SPONSORED_INDEX - 1) {
                          items.push(
                            ...
                            >
                              {/* Soft amber sheen so the slot reads as 'this is the paid product' */}
                ...
                {/* Annotation callouts pointing at what makes the slot valuable */}
                <div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-3 text-[11px]">
                  <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-50/50 border border-amber-100">
                    <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-amber-200 text-amber-800 font-bold text-[10px] flex-shrink-0">1</span>
                    <div>
                      <p className="font-semibold text-neutral-900">Top-3 placement</p>
                      <p className="text-neutral-600 mt-0.5">Premium slots appear before #4 on every page view.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-50/50 border border-amber-100">
                    <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-amber-200 text-amber-800 font-bold text-[10px] flex-shrink-0">2</span>
                    <div>
                      <p className="font-semibold text-neutral-900">Clearly labeled</p>
                      <p className="text-neutral-600 mt-0.5">The "Ad" pill keeps it honest. Trust stays intact.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-50/50 border border-amber-100">
                    <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-amber-200 text-amber-800 font-bold text-[10px] flex-shrink-0">3</span>
                    <div>
                      <p className="font-semibold text-neutral-900">First-come queue</p>
                      <p className="text-neutral-600 mt-0.5">Slots auto-promote as openings free up. Cancel anytime.</p>
                    </div>
                  </div>
                </div>
