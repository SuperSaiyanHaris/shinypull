...
async function researchAgent(articles, postData) {
  ...
  const text = await callWithRetry(() => geminiGenerate(`You are a research editor for ShinyPull, a creator analytics platform tracking YouTube, TikTok, Twitch, Kick, Bluesky, Mastodon, Rumble, and Music stats.
...
- Platform feature launches (YouTube, TikTok, Twitch, Kick, Mastodon, Rumble)
...
async function enrichmentAgent(research) {
  ...
  const enrichmentRaw = await callWithRetry(() => geminiGenerate(`You are a research enrichment specialist for ShinyPull, a creator analytics platform (YouTube, TikTok, Twitch, Kick, Bluesky, Mastodon, Rumble, and Music stats).
